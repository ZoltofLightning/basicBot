...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/ZoltofLightning/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        chatUtilities: {
            ...
            spam: [
                ...
                'gringo', 'fuder', 'foder', 'hua', 'ahue', 'modafuka', 'modafoka', 'mudafuka', 'mudafoka', 'ooooooooooooooo', 'foda', 'FUUUUUUUUUUUUUUUUUCK'
            ],
            curses: [
                'cock', 'ass', 'dick', 'nigger', 'faggot', 'nigga', 'niqqa', 'motherfucker', 'modafocka', 'fuck', 'shit', 'fucking', 'bitch', 'fucker', 'pussy', 'cunt', 'kant', 'fuckboi'
            ]
        },
        connectAPI: function () {
            this.proxy = {
            ...
            sourceCommand: {
                ...
                functionality: function (chat, cmd) {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        API.sendChat('/me This bot is owned by ZoltofLightning, was originally created by ' + botCreator + ', previously maintained by ' + botMaintainer + ' and helped by ' + botHelper + ".");
                    }
                }
            },
